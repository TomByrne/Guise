...
extern class Tween {
	...
	*
	*/
	public static function get (target:Dynamic, props:{Loop:Bool, paused:Bool}={Loop:true, paused:true}):Dynamic;
	...
	*
	*/
	public function set (props:Dynamic, target:Dynamic):Dynamic;
	...
	*
	*/
	public function to (props:Dynamic, duration:Dynamic, ease:Dynamic):Dynamic;
