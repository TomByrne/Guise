...
class WebViewAndroidTest extends Sprite
{
	public static function main() {
		new WebViewAndroidTest();
	}
   ...
   function launchWeb()
   {
     ...
     // trace("LAUNCH ========= " + launch);
      ...
      var launch:Dynamic = nme.JNI.createStaticMethod("nme/NMEWebView", "nmeCreate", "()Landroid/widgets/Button;");

      if (launch!=null)nme.Lib.postUICallback( function() { launch(); } );
   }
}